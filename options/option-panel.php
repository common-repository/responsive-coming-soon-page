				...
				<div class="container-fluid top">
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<h2 class="rcinline"><img src="<?php echo esc_url(RCSM_PLUGIN_URL); ?>options/images/logo.png" alt="Weblizar" />
			  ...
			  if($auto_sentto_activeusers == 'on')
			   {
				...
				$email_check = $wpdb->get_results($wpdb->prepare("SELECT * FROM %s WHERE flag = '1'", $table_name));
					if($email_check){
