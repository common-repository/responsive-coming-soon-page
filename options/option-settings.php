									...
									<div class="selected_template active">
										<div class="row op_show" data-orient="top">
											<div class="op_weblizar-pics-activated">
												<span class="image-shop-scroll" style="background-image: url('<?php echo esc_url(plugin_dir_url(__FILE__) . 'images/screen-shot' . $i . '.jpg'); ?>')"></span>
											</div>
										</div>
								...
								<div style="width:48%" class="col-md-3 col-sm-6 op_tem site_template <?php if ($wl_rcsm_options['select_template'] == 'select_template' . $i) echo 'active'; ?>" id="select_template<?php echo esc_attr($i); ?>">
									<div class="selected_template active">
										...
										<h4 class="op_name"><?php esc_html_e('Template ' . $i, 'RCSM_TEXT_DOMAIN'); ?>
											<a class="btn btn-primary btn_template" target="_new" href="<?php echo esc_url('http://demo.weblizar.com/coming-soon-page-pro/template-' . esc_attr($i) . '/'); ?>" rel="nofollow"><?php esc_html_e('View Demo', 'RCSM_TEXT_DOMAIN') ?></a>
										</h4>
									</div>
								</div>
							<?php } ?>
						...
						<div class="layout-options <?php if ($site_layout == 'coming_soon_switch') echo "active"; ?>" id="coming_soon_switch">
							...
							<div class="col-md-6 form-group">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<textarea class="form-control" rows="8" cols="8" id="coming-soon_message" name="coming-soon_message"><?php if ($wl_rcsm_options['coming-soon_message'] != '') {
																																					echo esc_attr($wl_rcsm_options['coming-soon_message']);
																																				} ?></textarea>
									</div>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-md-3">
											...
											<div class="col-													<?php
																												...
																												if (!empty($todisable)) { // Correctly check if the array is not empty
		...
		<div class="tab-content">
			<div id="page-social" class="tab-pane fade in active">
				...
				<form action="post" id="weblizar_rcsm_social_option">
					<!-- <h1> <?php //esc_html_e('Social Link And Icon Settings', 'RCSM_TEXT_DOMAIN');
								?></h1> -->
								...
								<div class="col-md-12 form-group" id="rcsm_social-<?php echo esc_attr($i); ?>">
									<div class="row">
										...
										<div class="col-md-3">
											...
											<input class="form-control" type="checkbox" <?php if ($wl_rcsm_options['link_tab_' . $i] == 'on') {
																							echo "checked='checked'";
																						} ?> id="link_tab_<?php echo esc_attr($i); ?>" name="link_tab_<?php echo esc_attr($i); ?>" />
										</div>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									...
									<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add a text for a already subscribed message.", "RCSM_TEXT_DOMAIN"); ?>"><i class="fas fa-info-circle tt-icon"></i></a></label>
								</div>
								<div class="col-md-3">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									...
									<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add a text for a error message about showing of the Invalid details sent by subscribed users", "RCSM_TEXT_DOMAIN"); ?>"><i class="fas fa-info-circle tt-icon"></i></a></label>
								</div>
								<div class="col-md-3">
				...
				<form action="post" id="weblizar_rcsm_subscribe_form">
					...
					<div class="col-md-12 form-group">
						<div class="col-md-3">
							...
							<textarea class="form-control" rows="8" cols="8" id="subscriber_mail_message" name="subscriber_mail_message" placeholder="<?php esc_html_e('Add a Message to send subscriber Users', 'RCSM_TEXT_DOMAIN'); ?>"><?php if ($wl_rcsm_options['subscriber_mail_message'] != '') {
																																																												echo esc_attr($wl_rcsm_options['subscriber_mail_message']);
																																																											} ?></textarea>
							<!--<button name="submit_subscriber" class="subscriber_submit btn" type="submit"><?php // esc_html_e('Send','RCSM_TEXT_DOMAIN');
																												?></button> -->
									...
									if ($user_sets = $user_sets_all)
										if (count($user_sets) > 0) {
											...
											<tr style="background-color: #f9f6f6;" class="all_users">
												<!-- <td class="check-column"><?php //echo '<input type="checkbox" name="checkboxlist" class="select_ids" value="' . esc_js(esc_html($user_set->id)) . '">';
																				?></td> -->
						...
						<div class="col-md-12 form-group">
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-3">
										<label><?php esc_html_e('Title', 'RCSM_TEXT_DOMAIN'); ?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Enter Counter Clock Title Here", "RCSM_TEXT_DOMAIN"); ?>"><i class="fas fa-info-circle tt-icon"></i></a></label><br />
									</div>
									<div class="col-md-3">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Enter Counter Clock Message Here", "RCSM_TEXT_DOMAIN"); ?>"><i class="fas fa-info-circle tt-icon"></i></a></label><br />
									</div>
									<div class="col-md-3">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php esc_attr_e("Add Live time here.", "RCSM_TEXT_DOMAIN"); ?>"><i class="fas fa-info-circle tt-icon"></i></a></label><br />
									</div>
									<div class="col-md-3">
										<input class="form-control" type="text" name="maintenance_date" id="maintenance_date" value="<?php if ($wl_rcsm_options['maintenance_date'] != '') {
																																			echo esc_attr($wl_rcsm_options['maintenance_date']);
																																		} ?>">
